...
public class LandGenerator {
		...
		switch (x) {
			...
			case 3:
				for (int i = 0; i < y; i++) {
					//Holds random number.
					x = gen.nextInt(5);
					spriteStrip[i] = makeSpecialStrip(i, x, "/Misc/Water.png", "/Misc/Logs.png", "/Misc/Logs.png");
				}
		}
	...
	Sprite[] getWaterStrip() {
		...
		for (int i = 0; i < 12; i++) {
			//Holds random number.
			int x = gen.nextInt(5);
			spriteStrip[i] = makeSpecialStrip(i, x, "/Misc/Water.png", "/Misc/Water.png", "/Misc/Logs.png");
		}
